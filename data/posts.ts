...
const comments: Comment[] = [
  ...
  },
  {
    id: nextCommentId++,
    author: users[3],
    content: "Adding this to my TBR pile immediately! Your review convinced me. 📚",
  ...
  },
  {
    id: nextCommentId++,
    author: users[2],
    content: "I'm so jealous of your cozy reading nook! The lighting looks perfect for those long reading sessions.",
  ...
  },
  {
    id: nextCommentId++,
    author: users[0],
    content: "That bookstore is one of my favorites! Did you find anything good in their rare books section?",
  ...
  },
  {
    id: nextCommentId++,
    author: users[1],
    content: "Congratulations on finishing your reading challenge! What was your favorite book from the list?",
